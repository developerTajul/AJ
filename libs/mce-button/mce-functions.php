...
function wpbootscore_add_tinymce_button_js( $button_js ) {
	$button_js['wpbootscore_mce_button'] = get_stylesheet_directory_uri() . '/libs/mce-button/mce-button.js';
	return $button_js;
}
...
function wpbootscore_add_tinymce_button_css() {
	wp_enqueue_style('wpbootscore_mce_button', get_stylesheet_directory_uri() . '/libs/mce-button/mce-button.css' );
}
